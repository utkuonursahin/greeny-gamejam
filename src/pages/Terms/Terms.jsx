const Terms = () => {
  return (
    <main className="terms">
      <h1 className="heading-1">Kurallar ve Şartname</h1>
      <p className="terms__content">
        <span>Başvuru formunu gönderdiğiniz zaman tüm kuralları kabul ettiğiniz varsayılır.</span>
        <span>Etkinliklerde herhangi bir cihaz desteği sağlanamayacaktır. Her katılımcının kendi cihazlarını getirmesi gerekmektedir.</span>
        <span>Etkinliğe bireysel olarak katılım mevcuttur.</span>
        <span>Takımlar için kişi sayısı sınırı en fazla 5 kişidir.</span>
        <span>Her takımın her üyesi formu ayrı ayrı doldurmalıdır.</span>
        <span>Takımlar Game Jam esnasında verilen tema doğrultusunda diledikleri kadar oyun yapma hakkına sahiptirler.</span>
